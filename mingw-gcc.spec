...
Patch1: gcc-gnat-allow-shared-for-cross.patch

BuildRequires:	autoconf
BuildRequires:  gcc-c++
BuildRequires:  gcc-gnat
BuildRequires:  libgnat
BuildRequires:  libgnat-devel
BuildRequires:  make
...
%package -n mingw32-gcc-gnat
Summary:        MinGW Windows cross-compiler for Ada for the win32 target
Requires:       mingw32-gcc = %{version}-%{release}

%description -n mingw32-gcc-gnat
MinGW Windows cross-compiler for Ada for the win32 ta
...
%package -n mingw64-gcc-gnat
Summary:        MinGW Windows cross-compiler for Ada for the win64 target
Requires:       mingw64-gcc = %{version}-%{release}

%description -n mingw64-gcc-gnat
MinGW Windows cross-compiler for Ada for the win64 target.
...
# List of /usr/bin/gnat* files
%global gnat_exe_list bind,chop,clean,find,kr,link,ls,make,name,prep,xref
%files -n mingw32-gcc-gnat
%{_bindir}/%{mingw32_target}-gnat{,%{gnat_exe_list}}
%{_libexecdir}/gcc/%{mingw32_target}/%{version}/gnat1
%if 0%{bootstrap} == 0
%{_prefix}/lib/gcc/%{mingw32_target}/%{version}/ada{include,lib}/*
%{_prefix}/lib/gcc/%{mingw32_target}/%{version}/ada_target_properties
%endif

%files -n mingw64-gcc-gnat
%{_bindir}/%{mingw64_target}-gnat{,%{gnat_exe_list}}
%{_libexecdir}/gcc/%{mingw64_target}/%{version}/gnat1
%if 0%{bootstrap} == 0
%{_prefix}/lib/gcc/%{mingw64_target}/%{version}/ada{include,lib}/*
%{_prefix}/lib/gcc/%{mingw64_target}/%{version}/ada_target_properties
%endif
